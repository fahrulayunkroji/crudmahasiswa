...
<body>
    ...
    <div class="col-md-6 offset-md-3 align-self-center"> 
      ...
      <form method="POST">
        ...
        <div class="mb-3">
          ...
          <input type="number" class="form-control" id="inputNis" value="<?= $data['nis'] ?>" name="nis" placeholder="Masukan Nim ">
        </div>
        <div class="mb-3">
       ...
       <div class="mb-3">
          ...
          <input type="text" class="form-control" id="inputalamat" value="<?= $data['alamat'] ?>" name="alamat" placeholder="Masukan alamat">
        </div>
        <div class="mb-3">
  ...
  <?php
    ...
    if(isset($_POST['daftar'])){
      ...
      // Membuat Query
      $query = "UPDATE tb_siswa SET nis = '$nis', nama = '$nama', alamat = '$alamat', kelas = '$kelas' WHERE id = '$id'";
